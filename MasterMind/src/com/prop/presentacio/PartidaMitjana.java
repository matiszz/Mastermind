 ...
 * @author mati
 */
public class PartidaMitjana extends Partida {
    
    private int MAX_LINES = 8;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartidaMitjana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PartidaMitjana().setVisible(true);
            }
        });
    }
